...
interface LinkButtonProps extends Pick<React.LinkHTMLAttributes<HTMLLinkElement>, "className" | "children"> {
...
const LinkButton = ({type = "plain", children, onClick, className, size = "small", href, target}: LinkButtonProps) => {

    return <LinkButtonWrapper onClick={onClick} target={target} href={href} to={href} className={`_${type} _${size} ${className}`}>
        {children}
    </LinkButtonWrapper>
