...
const AppFormUI = ({formProps, id}: AppFormUIProps) => {
    ...
    return <AppFormUIWrapper
        onSubmit={formProps.handleSubmit(
            (data: any) => AddAppController.onSubmit(data, action, defaultValue?.id, setErrors),
            (e: any) => AddAppController.onErrors(e, setErrors)
        )}>
        <h2>Participate and add your application here</h2>
        <p><strong className="important">VERY IMPORTANT!</strong> <br/> Make sure to fill the form well before
            submitting
            please. </p>
        ...
        <section className={"section-block app-info"}>
            ...
            <UploadLogo errors={errors} logo={defaultValue?.logoUrl} formProps={formProps}/>
            <div className="basic-form m-top">
                <InputBuilder invalid={errors?.["name"] !== undefined} required={false}
                              errors={errors} name={"name"} defaultValue={defaultValue?.name ?? ""}
                              register={formProps.register}
                              setValue={formProps.setValue} type={"text"} labelText={"Name"}
                              placeholder={"Enter the app's name"}/>
                <InputBuilder required={false} errors={errors} name={"websiteUrl"}
                ...
                <InputBuilder required={false} errors={errors} name={"playstoreUrl"}
                              ...
                              placeholder={"https://..."}/>
                <InputBuilder required={false} errors={errors} name={"appstoreUrl"}
                ...
                <div>
                    ...
                    {
                        (errors && errors["categoryId"]) && <span className={"error-message"}>{errors["categoryId"]?.message}</span>
                    }
                </div>
                <div>
                    ...
                    {
                        (errors && errors["genreId"]) && <span className={"error-message"}>{errors["genreId"]?.message}</span>
                    }
                </div>
            </div>
            <div className="basic m-top">
                <InputBuilder required={false} errors={errors} name={"tags"}
        ...
        <section className={"section-block app-info"}>
            ...
            <div className="basic-form">
                <InputBuilder required={false} errors={errors} name={"githubUrl"}
                              ...
                              placeholder={"https://..."}/>
                <InputBuilder required={false} errors={errors} name={"slackUrl"}
                              ...
                              placeholder={"https://..."}/>
                <InputBuilder required={false} errors={errors} name={"telegramUrl"}
                              ...
                              placeholder={"https://..."}/>
                <InputBuilder required={false} errors={errors} name={"dikaloUrl"}
                              ...
                              placeholder={"https://..."}/>
                <InputBuilder required={false} errors={errors} name={"whatsappUrl"}
                              ...
                              placeholder={"https://..."}/>
                <InputBuilder required={false} errors={errors} name={"facebookUrl"}
                              ...
                              placeholder={"https://..."}/>
                <InputBuilder required={false} errors={errors} name={"twitterUrl"}
                              ...
                              placeholder={"https://..."}/>
                <InputBuilder required={false} errors={errors} name={"linkedinUrl"}
        ...
        <section className={"section-block app-more"}>
            ...
            <div className="basic">
                <InputBuilder required={false} errors={errors} name={"description"}
